...
- Getting Started
  ...
  - [Developing a Pixel app](getting-started/developing-a-pixel-app/1)
    - [Basic setup to develop in VTEX IO](getting-started/developing-a-pixel-app/2)
    - [Cloning the boilerplate repository](getting-started/developing-a-pixel-app/3)
    - [Defining your app settings](getting-started/developing-a-pixel-app/4)
    - [Writing the header and body scripts](getting-started/developing-a-pixel-app/5)
    - [Listening to store events](getting-started/developing-a-pixel-app/6)
    - [Structuring the documentation](getting-started/developing-a-pixel-app/7)
    - [Making your Pixel app publicly available](getting-started/developing-a-pixel-app/8)
