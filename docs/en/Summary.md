...
- Getting Started
  ...
  - [Develop native integrations with Pixel apps](getting-started/develop-native-integrations-with-pixel-apps/1)
    - [Basic setup to develop in VTEX IO](getting-started/develop-native-integrations-with-pixel-apps/2)
    - [Cloning the boilerplate repository](getting-started/develop-native-integrations-with-pixel-apps/3)
    - [Defining your app settings](getting-started/develop-native-integrations-with-pixel-apps/4)
    - [Writing the header and body scripts](getting-started/develop-native-integrations-with-pixel-apps/5)
    - [Listening to store events](getting-started/develop-native-integrations-with-pixel-apps/6)
    - [Structuring the documentation](getting-started/develop-native-integrations-with-pixel-apps/7)
    - [Making your Pixel app publicly available](getting-started/develop-native-integrations-with-pixel-apps/8)
...
- Recipes
  ...
  - [Store Management](recipes/store-management)
    ...
    - [Indicating alternate versions of localized pages in cross border stores](recipes/store-management/indicating-alternate-pages-in-cross-border-stores.md)  
